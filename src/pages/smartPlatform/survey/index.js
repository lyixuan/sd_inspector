...
import { fillCollege,fillFamily } from './component/EchartCommonOptions/fillRateOptions';
              ...
              <div className={styles.echartCls}>
                {
                  JSON.stringify(data1)==='{}'?
                    ...
                    <Echart update={data1} style={{ width: '49%', height: "510px" ,boxShadow:'0 0 20px #0070b7',backgroundColor:'#0c162f'}} options={option1} />
                }
                {
                  JSON.stringify(data2)==='{}'?
                  <Empty className={styles.emptyCls} />:
                  <Echart update={data2} style={{ width: '49%', height: "510px",boxShadow:'0 0 20px #0070b7',backgroundColor:'#0c162f' }} options={option2} />
                }
              </div>
            </Spin>
