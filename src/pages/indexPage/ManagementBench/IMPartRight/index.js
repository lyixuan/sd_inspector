    ...
    const columns = [
      {
        ...
        render: (badContrasts, record) => {
          ...
          return<div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <BIWrapperProgress text={text} percent={percent}  propsStyle={{flex: 'inherit',width: '46px',textAlign:"right"}}/>
          </div>
        ...
        render: (notInTime, record) => {
          ...
          return <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <BIWrapperProgress text={notInTime} percent={percent}  propsStyle={{flex: 'inherit',width: '46px',textAlign:"right"}}/>
          </div>
        },
      }, {
        title: '未回复',
        ...
        render: (notReply, record) => {
          ...
          return <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <BIWrapperProgress text={notReply} percent={percent}  propsStyle={{flex: 'inherit',width: '46px',textAlign:"right"}}/>
          </div>
        },
      },
    ]
