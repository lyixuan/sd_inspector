  ...
  render() {
    ...
    return (
      <Container
        ...
        right={
          <>
            <BIButton onClick={() => handleDataTrace({"widgetName":"学分趋势","traceName":"班主任工作台/学分趋势"})} type="online" style={{marginRight: '8px'}}><Link to={`/xdCredit/index?params=${JSON.stringify({startTime, endTime }) }`} target='_black'>
