  ...
  return (
      <Spin spinning={false}>
        <div className={style.box}>
          ...
          <div  className={style.line}><span>开始日期：</span><BIDatePicker style={{ width: 230 }}  onChange={(val,valStr) => this.onFormChange(valStr, 'beginDate')}/></div>
          <div className={style.line}><span>结束日期：</span><BIDatePicker style={{ width: 230 }}  onChange={(val,valStr) => this.onFormChange(valStr, 'endDate')}/>&nbsp;&nbsp;
        ...
        <div className={style.box}>
          ...
          <div  className={style.line}><span>日报下载：</span>
            <BISelect style={{ width: 230 }} placeholder="请选择" value={this.state.qualityType} onChange={(val) => this.onFormChange(val, 'qualityType')}>
