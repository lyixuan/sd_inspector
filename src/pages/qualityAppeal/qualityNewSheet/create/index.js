          ...
          <div className={styles.content}>
            ...
            <Row>
              <Col className="gutter-row" span={12} style={{ display: "flex" }}>
                ...
                <div style={{ marginTop: "4px", marginLeft: "15px" }}><BIButton type="primary" htmlType="submit">查询</BIButton></div>
              </Col>
            </Row>
              ...
              <div className={styles.verifyContent}>
                ...
                <Row>
                  <Col span={24} style={{ display: "flex" }}>
                    ...
                    <span className={styles.texts}>郭珊老师在4月2日19:30-21:00讲的【开学典礼】教师资格证课程中，在课程31分23秒老师介绍教师资格证时，只介绍了资格证的考试时间，考试安排，含金量，全国通用，未介绍资格证的定义，PPT也未展示定义，参考话术：职业资格证即职业资格证书，是表明劳动者具有从事某一职业所必备的学识和技能的证明。</span>
                  </Col>
                </Row>
              </div>
            </div>
            ...
            <Row className="gutter-row">
              <Col span={24} >
                <div className={styles.gutterBox1}>
                  <span className={styles.gutterBtn2}><BIButton >取消</BIButton></span>
                  <span className={styles.gutterBtn1}><BIButton type='primary'>提交</BIButton></span>
                </div>
              </Col>
            </Row>
          </div>
