...
class Index extends React.Component {
  ...
  render() {
    ...
    const InfoList1 = dataList1.appealStart && dataList1.appealStart.map((v,i)=>{if (i===0) {return <Info type='startAppeal' data={v}/>}});
    const InfoList2 = dataList2.appealStart && dataList2.appealStart.map((v,i)=>{if (i===0) {return <Info type='startAppeal' data={v}/>}});
    return (
      <div>
        {
          data1 ? (
