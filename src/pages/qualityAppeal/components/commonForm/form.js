...
class CreateQualityNewSheet extends React.Component {
  ...
  qualityChange = qualityType => {
    ...
    if (this.props.onChangedimensionTree) {
      this.props.onChangedimensionTree({
        ...
        masterMail: null,
        masterRole2: null,
        masterQualityValue2: null,
        masterMail2: null,
        masterRole3: null,
        masterQualityValue3: null,
        masterMail3: null,
        masterRole4: null,
  ...
  changeDimension = (dimensionId, ops) => {
    ...
    if (this.props.changeDimension) {
      this.props.changeDimension(
        { qualityType, dimensionId, violationName: children },
        { ...params, dimensionId }
      );
    }
  };
  ...
  getDimensionTreeList = () => {
    ...
    return qualityType && dimensionId
      ? dimensionTreeList[0]
        ? dimensionTreeList[0].children
        : []
      : [];
  };
  ...
  renderGovernorComponent = showMore => {
    ...
    if (
      ...
      params.masterMail3 ||
      params.masterMail4 ||
      params.masterQualityValue3 ||
      params.masterQualityValue4
    ) {
      showMore = true;
    }
    if (isShowMasterMail) {
        ...
        <div>
              ...
              <Form.Item label="连带责任人：">
                {getFieldDecorator('masterRole', {
                  ...
                  <BIInput
                    ...
                    onChange={e => this.inputChange(e, 'masterRole')}
                  />
                )}
              </Form.Item>
              <Form.Item label="">
              ...
              <Form.Item label="">
                {getFieldDecorator('masterRole2', {
                  ...
                  <BIInput
                    placeholder="请输入角色"
                    style={{ width: 100, marginRight: '10px' }}
                    onChange={e => this.inputChange(e, 'masterRole2')}
                  />
                )}
              </Form.Item>
              <Form.Item label="">
                ...
                <Form.Item label="">
                  {getFieldDecorator('masterRole3', {
                    ...
                    <BIInput
                      placeholder="请输入角色"
                      style={{ width: 100, marginRight: '10px' }}
                      onChange={e => this.inputChange(e, 'masterRole3')}
                    />
                  )}
                </Form.Item>
                <Form.Item label="">
                ...
                <Form.Item label="">
                  {getFieldDecorator('masterRole4', {
                    ...
                    <BIInput
                      placeholder="请输入角色"
                      style={{ width: 100, marginRight: '10px' }}
                      onChange={e => this.inputChange(e, 'masterRole4')}
                    />
                  )}
                </Form.Item>
                <Form.Item label="">
          ...
          {showMore ? (
            <Row style={{ marginBottom: 10 }}>
              <Col span={24}>
                <span onClick={this.changeShowMore} className={styles.more}>
                  收起更多
                </span>
              </Col>
            </Row>
      ...
      <div className={styles.commonformWrap}>
        ...
        <Form layout="inline" onSubmit={this.handleSubmit} className={styles.formBox}>
            ...
            <Row style={{ lineHeight: '40px' }}>
              <Col className="gutter-row" span={12} style={{ display: 'flex' }}>
                ...
                <div>
                  <BIButton
                    type="primary"
                    onClick={this.getOrgMapByMail}
                    loading={this.props.mailDataLoading}
                  >
                    查询
                  </BIButton>
                </div>
          ...
          <div className={styles.content}>
            ...
            <Row>
              <Col className="gutter-row" span={12} style={{ display: 'flex' }}>
                <span className={styles.i} style={{ display: 'inline-block', width: '7.24px' }}>
                  &nbsp;
                </span>
                ...
                <div style={{ marginTop: '4px', marginLeft: '15px' }}>
                  <BIButton
                    type="primary"
                    onClick={this.getOrderNum}
                    loading={this.props.getOrderNumLoading}
                  >
                    查询
                  </BIButton>
                </div>
          ...
          <div className={styles.content}>
              ...
              <Col className="txRight" span={12}>
                ...
                <Form.Item label="违规等级:">
                  <div style={{ width: '280px', textAlign: 'left' }}>
                    {violationLevelObj.violationLevelName}
                  </div>
                </Form.Item>
              </Col>
            </Row>
            ...
            <Row className="gutter-row">
              <Col span={12}>
                <span className={styles.i}>&nbsp;</span>
                <Form.Item label="附件：">{this.renderUpload()}</Form.Item>
              </Col>
            </Row>
            ...
            {/* 显示children */}
            <Row>
              <Col span={24}>{this.props.otherNode}</Col>
            </Row>
            <Row className="gutter-row">
              <Col span={24}>
                <div className={styles.gutterBox1}>
                  ...
                  <span className={styles.gutterBtn1}>
                    <BIButton
                      type="primary"
                      htmlType="submit"
                      loading={this.props.checkRepeatQualityIng}
                    >
                      提交
                    </BIButton>
                  </span>
