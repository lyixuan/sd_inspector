  ...
  render() {
    ...
    return (
      <div style={{ width: '100%' }}>
        ...
        {imgList[initShowList[0]]&&<img src={imgList[initShowList[0]]} className={styles.img}/>}
        <span className={styles.slice}/>
        {imgList[initShowList[1]]&&<img src={imgList[initShowList[1]]}  className={styles.img}/>}
        <span className={styles.slice}/>
        {imgList[initShowList[2]]&&<img src={imgList[initShowList[2]]}  className={styles.img}/>}
