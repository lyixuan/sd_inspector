...
const allData = [{
  ...
  enroll: { start: '2019-11-19', end: '2019-11-19', name: '新生报考' },
  oldEnroll: { start: '2019-11-21', end: '2019-11-21', name: '老生报考' },
  scene: { start: '2019-11-19', end: '2019-11-19', name: '新生确认' },
        ...
        <div className={styles.examDate}>
          {
            ...
            >
              {yearMonthList.map((item, index) => (
                <Option data-trace={`{"widgetName":"切换考期","traceName":"报考大盘/切换考期/${item.examYearMonthStr}"}`} key={item.id} value={item.id}>
